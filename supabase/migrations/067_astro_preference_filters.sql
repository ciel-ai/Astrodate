ALTER TABLE public.user_preferences
  ADD COLUMN IF NOT EXISTS preferred_elements TEXT[] NOT NULL DEFAULT '{}',
  ADD COLUMN IF NOT EXISTS blocked_signs       TEXT[] NOT NULL DEFAULT '{}';

-- ── 2. get_final_matches (replaces migration 055) ───────────────────────────
