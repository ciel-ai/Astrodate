-- Migration 087: Fix personality score calculation bugs (double multiplication and NULL propagation)
-- Fixes final_match_score evaluating to NULL when some personality traits are missing,
-- and fixes personality_score evaluating to 450 (which caused > 100% compatibility matches in UI).
